$(document).ready(function () {
  ...
  var repaint = function () {
    ...
    $topLeft.height(minDimension * 1 / 7)
    $topLeft.width(minDimension * 1 / 7)
    $topLeft.offset({top: minDimension * 2 / 7 + extraY / 2, left: minDimension * 2 / 7 + extraX / 2});
    $topRight.height(minDimension * 1 / 7)
    $topRight.width(minDimension * 1 / 7)
    $topRight.offset({top: minDimension * 2 / 7 + extraY / 2, left: minDimension * 4 / 7 + extraX / 2});
    $bottomLeft.height(minDimension * 1 / 7)
    $bottomLeft.width(minDimension * 1 / 7)
    $bottomLeft.offset({top: minDimension * 4 / 7 + extraY / 2, left: minDimension * 1 / 7 + extraX / 2});
    $bottomRight.height(minDimension * 1 / 7)
    $bottomRight.width(minDimension * 1 / 7)
    $bottomRight.offset({top: minDimension * 4 / 7 + extraY / 2, left: minDimension * 5 / 7 + extraX / 2});
    $bottomMiddle.height(minDimension * 1 / 7)
    $bottomMiddle.width(minDimension * 5 / 7)
    $bottomMiddle.offset({top: minDimension * 5 / 7 + extraY / 2, left: minDimension * 1 / 7 + extraX / 2});
